...
class RayResourcePool(ResourcePool):
    ...
    def get_placement_groups(self, strategy="STRICT_PACK", name=None, device_name="cuda"):
        ...
        print(f"Waiting for {len(pgs)} placement groups to be ready...")
        ray.get([pg.ready() for pg in pgs])
        print(f"Placement groups are ready.")
...
class RayWorkerGroup(WorkerGroup):
    ...
    def _get_master_addr_port(self, pg):
        ...
        print("Getting master addr and port...")
        ...
        print(f"Got master addr: {self._master_addr}, port: {self._master_port}")
