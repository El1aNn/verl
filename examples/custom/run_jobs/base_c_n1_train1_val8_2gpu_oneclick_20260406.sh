...
if [[ "${1:-}" != "--foreground" ]]; then
    SESSION_NAME="${SESSION_NAME:-base_c_n1_val8_2gpu}"
...
unset RAY_ADDRESS RAY_GCS_ADDRESS RAY_DASHBOARD_ADDRESS
...
EXP_NAME="${EXP_NAME:-base_c_n1_train1_val8_2gpu_$(date +%Y%m%d_%H%M%S)}"
...
export VERL_FILE_LOGGER_ROOT="${METRICS_DIR}"
