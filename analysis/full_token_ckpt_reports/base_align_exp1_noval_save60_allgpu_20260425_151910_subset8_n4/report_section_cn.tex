...
本次离线评估覆盖 step 0 到 step 180，每个 step 包含 8 道题、32 条采样响应。最终 checkpoint 的平均 score 为 0.4375，最佳 checkpoint 为 step 120，best score 为 0.4375。从行为指标看，最终平均 response length 为 731.6，token entropy 为 0.2792，低置信 token 比例为 0.0577，平均 top-1 probability 为 0.9040。
