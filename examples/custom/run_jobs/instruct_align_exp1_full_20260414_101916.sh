...
cd '/root/rl/verl'
export PATH='/home/vipuser/miniconda3/envs/verl/bin:/home/vipuser/miniconda3/bin:/home/vipuser/miniconda3/condabin:'"${PATH}"
export SAVE_RUN_SCRIPT=false
export MANAGE_RAY_CLUSTER='false'
export EXP_NAME='instruct_align_exp1_full_20260414_101916'
export HOME_DIR='/root/rl'
export TRAIN_MODE='full'
export RAY_ADDRESS='192.168.122.3:6379'
export RAY_GCS_ADDRESS='192.168.122.3:6379'
export RAY_DASHBOARD_ADDRESS='http://192.168.122.3:8265'
export RAY_LOCAL_IP='192.168.122.3'
...
export TRAIN_FILE='/root/rl/verl/data/dsr_sub/train.parquet'
export VAL_PATH='/root/rl/verl/data/testset'
export CKPTS_DIR='/root/rl/verl/ckpts/verl_grpo_dsr_sub_baseline/instruct_align_exp1_full_20260414_101916'
...
export LOG_FILE='/root/rl/verl/logs/verl_grpo_dsr_sub_baseline-instruct_align_exp1_full_20260414_101916-20260414-101916.log'
export REPORT_ROOT='/root/rl/verl/reports'
export REPORT_DIR='/root/rl/verl/reports/verl_grpo_dsr_sub_baseline/instruct_align_exp1_full_20260414_101916'
export TORCH_COMPILE_CACHE_ROOT='/tmp/verl_torch_compile_cache'
export TRITON_CACHE_DIR='/tmp/verl_torch_compile_cache/triton/instruct_align_exp1_full_20260414_101916'
export TORCHINDUCTOR_CACHE_DIR='/tmp/verl_torch_compile_cache/inductor/instruct_align_exp1_full_20260414_101916'
