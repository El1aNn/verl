...
export EXP_NAME='base_d_weak_constraint_20260402_002740'
...
export CKPTS_DIR='/root/rl/verl/ckpts/verl_grpo_dsr_sub_baseline/base_d_weak_constraint_20260402_002740'
...
export LOG_FILE='/root/rl/verl/logs/verl_grpo_dsr_sub_baseline-base_d_weak_constraint_20260402_002740-20260402-002749.log'
export REPORT_ROOT='/root/rl/verl/reports'
export REPORT_DIR='/root/rl/verl/reports/verl_grpo_dsr_sub_baseline/base_d_weak_constraint_20260402_002740'
export TORCH_COMPILE_CACHE_ROOT='/tmp/verl_torch_compile_cache'
export TRITON_CACHE_DIR='/tmp/verl_torch_compile_cache/triton/base_d_weak_constraint_20260402_002740'
export TORCHINDUCTOR_CACHE_DIR='/tmp/verl_torch_compile_cache/inductor/base_d_weak_constraint_20260402_002740'
