...
export EXP_NAME='base_c_n1_group_ablation_screen_20260401_102318'
...
export CKPTS_DIR='/root/rl/verl/ckpts/verl_grpo_dsr_sub_baseline/base_c_n1_group_ablation_screen_20260401_102318'
...
export ROLLOUT_LOG_PROB_MICRO_BSZ='32'
export REF_LOG_PROB_MICRO_BSZ='64'
export TP_SIZE='1'
...
export VAL_DIAG_MAX_TOKENS='192'
export VAL_DIAG_DUMP_SAMPLES='-1'
...
export VAL_DIAG_DISTRIBUTION_TOPK='64'
...
export LOG_FILE='/root/rl/verl/logs/verl_grpo_dsr_sub_baseline-base_c_n1_group_ablation_screen_20260401_102318-20260401-102326.log'
export REPORT_ROOT='/root/rl/verl/reports'
export REPORT_DIR='/root/rl/verl/reports/verl_grpo_dsr_sub_baseline/base_c_n1_group_ablation_screen_20260401_102318'
export TORCH_COMPILE_CACHE_ROOT='/tmp/verl_torch_compile_cache'
export TRITON_CACHE_DIR='/tmp/verl_torch_compile_cache/triton/base_c_n1_group_ablation_screen_20260401_102318'
export TORCHINDUCTOR_CACHE_DIR='/tmp/verl_torch_compile_cache/inductor/base_c_n1_group_ablation_screen_20260401_102318'
