...
export EXP_NAME="${EXP_NAME:-base_c_n1_val8_align_exp1_2gpu_$(date +%Y%m%d_%H%M%S)}"
...
export LOG_FILE="/root/rl/verl/logs/verl_grpo_dsr_sub_baseline-${EXP_NAME}-$(date +%Y%m%d-%H%M%S).log"
